...
@section('main-content')
    <div class="body-image" style="background-image: url('assets/img/Layer355.png');background-color: rgba(0,0,0,0.52);background-repeat: no-repeat;background-size: cover;background-position: center; margin-top:5.4em" >
            ...
            <div class="row">
                ...
                <div class="col" style="padding:20px;">
                    ...
                    <ul class="nav nav-tabs mb-3 justify-content-center" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" style="color: red; font-weight: 700;" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">LOGIN</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color: red; font-weight: 700;"  id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">SIGN UP</a>
                        </li>
                    </ul>
                            ...
                            <div class="container">
                                ...
                                <form method="post" action="{{ route('login') }}">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col"><input type="text" name="email" id="email" class="input-st" placeholder="Email Address" onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Email Address'" required="" style="width:100%;"></div>
                                    </div>
                                    <div class="row justify-content-center mt-3">
                                        <div class="col"><input type="password"  name="password" id="passowrd" placeholder="password" onfocus="this.placeholder = ''"
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="container">
                                ...
                                <form method="post" action="{{route('user-create')}}">
                                    @csrf
                                    <div class="row justify-content-center">
                                        <div class="col"><input type="text" id="name" name="name" class="input-st" placeholder="User Name"onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'User Name'" required="" style="width:100%;"></div>
                                    </div>
                                    <div class="row justify-content-center mt-3">
                                        <div class="col"><input type="text" id="email"  name="email" class="input-st" required="" placeholder="Email Address" onfocus="this.placeholder = ''"
